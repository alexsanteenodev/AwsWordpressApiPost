...
_DEFAULT_LOCATION_IDS = ["2840"]  # location ID for USA
...
def main(
    client: GoogleAdsClient, customer_id: str, location_ids: dict = _DEFAULT_LOCATION_IDS, language_id: str = "1000", keyword_texts: dict = None, page_url: str = None, site_url: str = None
):
    print("Generating keyword ideas from a list of seed keywords...")
    ...
    if not (keyword_texts or page_url or site_url):
        raise ValueError(
            "At least one of keywords or page URL or site URL is required, "
    ...
    return keyword_plan_idea_service.generate_keyword_ideas(
        request=request
    )
